...
namespace Trace {
  ...
  enum Term { // The first 8 entries are reserved for PieceType
    MATERIAL = 16, IMBALANCE, MOBILITY, THREAT, PASSED, SPACE, WINNABLE, TOTAL, TERM_NB
  };
...
namespace {
  ...
  constexpr Value LazyThreshold  = Value(2400);
  constexpr Value SpaceThreshold = Value(12222);

  // KingAttackWeights[PieceType] contains king attack weights by piece type
  constexpr int KingAttackWeights[PIECE_TYPE_NB] = { 0, 0, 81, 52, 44, 0, 10, 0 };
...
#define S(mg, eg) make_score(mg, eg)
  ...
  constexpr Score MobilityBonus[][32] = {
    ...
    { S(-30,-48), S(-12,-30), S( -8, -7), S( -9, 19), S( 20, 40), S( 23, 55), // Princess
    ...
    { S(-30,-48), S(-12,-30), S( -8, -7), S( -9, 19), S( 20, 40), S( 23, 55), // Queen
      ...
      S( 77,147), S( 79,150), S( 93,151), S(108,168), S(108,168), S(108,171),
      S(110,182), S(114,182), S(114,192), S(116,219) },
    { S(-30,-48), S(-12,-30), S( -8, -7), S( -9, 19), S( 20, 40), S( 23, 55), // Prince
      S( 23, 59), S( 35, 75), S( 38, 78), S( 53, 96), S( 64, 96), S( 65,100),
      S( 65,121), S( 66,127), S( 67,131), S( 67,133), S( 72,136), S( 72,141),
      S( 77,147), S( 79,150), S( 93,151), S(108,168), S(108,168), S(108,171),
      S(110,182), S(114,182), S(114,192), S(116,219) }
  ...
  constexpr Score ThreatByMinor[PIECE_TYPE_NB] = {
    S(0, 0), S(5, 32), S(57, 41), S(77, 56), S(88,119), S(88, 119), S(88,119), S(79, 161)
  };

  constexpr Score ThreatByRook[PIECE_TYPE_NB] = {
    S(0, 0), S(3, 46), S(37, 68), S(42, 60), S(0,38), S(0, 38), S(0, 38), S(58, 41)
  };
...
#undef S
  ...
  void Evaluation<T>::initialize() {
    ...
    constexpr Bitboard LowRanks = (Us == WHITE ? Rank2BB | Rank3BB : Rank8BB | Rank9BB);
    ...
    Square s = make_square(Utility::clamp(file_of(ksq), FILE_B, FILE_G),
                           Utility::clamp(rank_of(ksq), RANK_2, RANK_9));
  ...
  Score Evaluation<T>::king() const {
    ...
    constexpr Color    Them = ~Us;
    constexpr Bitboard Camp = (Us == WHITE ? AllSquares ^ Rank8BB ^ Rank9BB ^ Rank10BB
  ...
  Value Evaluation<T>::value() {
    ...
    // removed this assert because qsearch is removed.
    //assert(!pos.checkers());
